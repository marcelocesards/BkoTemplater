...
public class MetodoCriado implements Metodo {
	private String nome;
	...
	public MetodoCriado(String nome, List<Parametro> parametros, String body, Parametro retorno) {
		this.nome = nome;
	...
	private String getListaParametrosToString() {
